...
from framework.ui.base.base_test import BaseTest
from tests.ui.param.read_param import ReadParam

PARAM = ReadParam.get_param()


@pytest.mark.ui
@allure.feature('Kinopoisk test search')
class TestKinopoiskSearchFilm(BaseTest):
    ...
    def test_kinopoisk_search_film(self, param):
        ...
        self.film_page.make_screenshot('open_search_page')
        self.search_page.set_film_name(film_name)
        self.film_page.make_screenshot('set_film_name')
        self.search_page.set_country(country)
        self.film_page.make_screenshot('set_country')
        self.search_page.set_genre(genre)
        self.film_page.make_screenshot('set_genre')
        self.search_page.search()
        self.film_page.make_screenshot('click_search')
